                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{ asset('assets/imgs/shop/thumbnail-')}}{{$product->id}}-1.jpg" alt="product image"></div>
                                            <div><img src="{{ asset('assets/imgs/shop/thumbnail-')}}{{$product->id}}-2.jpg" alt="product image"></div>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                            ...
                            <div class="row mt-60">
                                ...
                                <div class="col-12">
                                    <div class="row related-products">
                                        @foreach ($rproudcts as $rproudct)
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.details',['slug'=>$rproudct->slug])}}" tabindex="0">
                                                            <img class="default-img" src="{{ asset('assets/imgs/shop/product-') }}{{$rproudct->id}}-1.jpg" alt="{{$rproudct->name}}">
                                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-') }}{{$rproudct->id}}-2.jpg" alt="{{$rproudct->name}}">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ route('product.details',['slug'=>$rproudct->slug])}}" tabindex="0">{{$rproudct->name}}</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>${{$rproudct->regular_price}}</span>
